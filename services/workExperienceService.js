...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveData(Models.workExperience, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.workExperience, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.workExperience, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.workExperience, where);
};
