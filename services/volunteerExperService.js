...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveData(Models.volunteerExperience, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.volunteerExperience, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.volunteerExperience, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.volunteerExperience, where);
};
