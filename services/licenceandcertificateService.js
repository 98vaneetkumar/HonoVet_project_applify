...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveData(Models.certification, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.certification, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.certification, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.certification, where);
};
