...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveBulData(Models.projectUnderTakenAddLink, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.projectUnderTakenAddLink, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.projectUnderTakenAddLink, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.projectUnderTakenAddLink, where);
};
...
exports.getAllUser = (criteria, projection, limit, offset) => {
	...
	return new Promise((resolve, reject) => {
		Models.projectUnderTakenAddLink
			.findAndCountAll({
				limit,
				offset,
				where: where,
