...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveBulData(Models.projectUndertakenProjectMedia, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.projectUndertakenProjectMedia, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.projectUndertakenProjectMedia, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.projectUndertakenProjectMedia, where);
};
...
exports.getAllUser = (criteria, projection, limit, offset) => {
	...
	return new Promise((resolve, reject) => {
		Models.projectUndertakenProjectMedia
			.findAndCountAll({
				limit,
				offset,
				where: where,
