...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveData(Models.language, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.language, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.language, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.language, where);
};
