...
exports.saveData = async (objToSave) => {
	...
	return await baseService.saveData(Models.education, objToSave);
};

exports.updateData = async (criteria, objToSave) => {
	console.log("obj to save=====>", objToSave)
	return await baseService.updateData(Models.education, criteria, objToSave);
};
exports.delete = async (criteria) => {
	return await baseService.delete(Models.education, criteria);
};
...
exports.count = async (criteria) => {
	...
	return await baseService.count(Models.education, where);
};
